...
/**
 * Created by github on 1/30/14.
 */
public interface Reporter {
    /**
     * Called by an {@link com.github.approval.Approval} object when values don't match in the approval process.
     *
    ...
    /**
     * Called by an {@link com.github.approval.Approval} object when a value for verification is produced but no old.
     *
     ...
     * com.github.approval.reporters.Reporters#firstWorking} will allow you to plug different reporters for different
