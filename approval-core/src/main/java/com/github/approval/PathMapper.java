 ...
 * com.github.approval.Approval#verify(Object, java.nio.file.Path)} for the path argument. This will map your approval
 * results file from the value for approval and a possible sub path.
 *
 * @param <T> the value that will be approved
 *
 * @see com.github.approval.pathmappers.ParentPathMapper
 */
